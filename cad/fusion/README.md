...
| MCU | Adafruit QT Py ESP32-S2 (5325) | 21.8 × 17.9 × 5.7 mm, no mounting holes |
...
To check the fit: **Inspect → Interference**, select all five components,
...
3. Drop the display module glass-first into the faceplate pocket. The rib holds
...
4. Screw the SHT41 to its bosses, chip facing forward. Slide the QT Py into its
   ...
   slot.
5. Feed the display's 8-pin header through the slot in the flange — it is
   taller than the space behind the module, so it deliberately protrudes into
   the MCU bay, and that is where the leads are landed.
6. Put the Gira frame over the faceplate, offer up the body, and pull the four
   M2.5 clamp screws up from the rear.
7. Screw the flange to the box with two M3.5 (the slots give a few mm of
...
- [Adafruit QT Py ESP32-S2 (5325)](https://www.adafruit.com/product/5325) — 21.8 × 17.9 × 5.7 mm
